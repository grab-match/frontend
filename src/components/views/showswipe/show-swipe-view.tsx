        ...
        >
          ...
          <div className="w-full">
            ...
            <div className="flex justify-between mb-2">
              ...
              <div onClick={() => router.push("/chat")} className="bg-[#1E938B] p-2 rounded-full flex items-center justify-center cursor-pointer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="30"
                  height="30"
