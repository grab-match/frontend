  ...
  return (
    <section className=" mx-auto max-w-[325px] py-3">
      <div className=" flex flex-col overflow-auto gap-2 flex flex-col">
        ...
        <div
          className="flex-grow p-2 py-3 bg-white h-[472px] flex-wrap w-full flex flex-col content-end justify-between text-white"
          style={{
            backgroundImage:
        ...
        >
          ...
          <div className="w-full">
            ...
            <div className="flex justify-between mb-2">
              ...
              <div className="bg-[#1E938B] p-2 rounded-full flex items-center justify-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="30"
                  height="30"
